  ...
  return (
    ...
    >
      ...
      <View style={styles.contentContainer}>
        <Text style={styles.mainHeading}>Find on Marketplace</Text>
      ...
      <View style={styles.buttonContainer}>
        ...
        <TouchableOpacity 
          ...
          onPress={() => navigation.navigate('RenewInsurence' as never)}
        >
...
export default FindOnMarketplace
